...
var _frangoYinYangPng = require("../img/frango_yin_yang.png");
var _frangoYinYangPngDefault = parcelHelpers.interopDefault(_frangoYinYangPng);
var _coquinhaGeladaPng = require("../img/coquinha_gelada.png");
var _coquinhaGeladaPngDefault = parcelHelpers.interopDefault(_coquinhaGeladaPng);
var _pudimPng = require("../img/pudim.png");
var _pudimPngDefault = parcelHelpers.interopDefault(_pudimPng);
class Prato {
...
class Pedido {
    ...
    confirmarPedido() {
        ...
        document.querySelector(".confirmar-pedido .sobremesa .preco").innerHTML = this.sobremesaSelecionada.preco.toFixed(2);
...
const pratos = [
    new Prato("Estrombelete de Frango", (0, _frangoYinYangPngDefault.default), "Um pouco de batata, um pouco de salada", 14.9),
    new Prato("Asa de Boi", (0, _frangoYinYangPngDefault.default), "Com molho shoyu", 14.9),
    new Prato("Carne de Monstro", (0, _frangoYinYangPngDefault.default), "Com batata assada e farofa", 14.9), 
];
const bebidas = [
    new Bebida("Coquinha gelada", (0, _coquinhaGeladaPngDefault.default), "Lata 350ml", 4.9),
    new Bebida("Caldo de Cana", (0, _coquinhaGeladaPngDefault.default), "Copo 600ml", 4.9),
    new Bebida("Corote Gelado", (0, _coquinhaGeladaPngDefault.default), "Garrafa 400ml", 4.9), 
];
const sobremesas = [
    new Sobremesa("Pudim", (0, _pudimPngDefault.default), "Gosto de doce de leite", 7.9),
    new Sobremesa("Flam", (0, _pudimPngDefault.default), "Gosto de chocolate", 7.9),
    new Sobremesa("Brigadeiro", (0, _pudimPngDefault.default), "3 unidades", 7.9), 
];
const pratosContainer = document.querySelector(".opcoes.prato");
pratos.forEach((prato)=>pratosContainer.appendChild(pedido.getPratoView(prato)));
const bebidasContainer = document.querySelector(".opcoes.bebida");
bebidas.forEach((bebida)=>bebidasContainer.appendChild(pedido.getBebidaView(bebida)));
const sobremesasContainer = document.querySelector(".opcoes.sobremesa");
sobremesas.forEach((sobremesa)=>sobremesasContainer.appendChild(pedido.getSobremesaView(sobremesa)));
...
},{"../img/frango_yin_yang.png":"hUaLZ","../img/coquinha_gelada.png":"gopFK","../img/pudim.png":"d2Kv9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hUaLZ":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("gGXMT") + "frango_yin_yang.7fea246f.png" + "?" + Date.now();
...
},{}],"gopFK":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("gGXMT") + "coquinha_gelada.41bf91a1.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"d2Kv9":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("gGXMT") + "pudim.73ee2e4f.png" + "?" + Date.now();
